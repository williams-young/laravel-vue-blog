...
class DiscussionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('web.discussion.index', compact('discussions'));
    }
    ...
    public function create()
    {
        ...
        return view('web.discussion.create', compact('tags'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('web.discussion.edit', compact('discussion', 'tags', 'selectTags'));
    }
